...
class Page(ttk.Frame):
    ...
    def __init__(self, root, page_name, view_change = False):        
        ...
        if view_change:
            ...
            ttk.Radiobutton(header, text="Recording Samples (fixed text)", width = 30, variable=root.page_from_header, command=lambda: root.change_page("TemplateTextPage"),value="TemplateTextPage", bootstyle="outline-toolbutton").grid(row=0, column=2)
